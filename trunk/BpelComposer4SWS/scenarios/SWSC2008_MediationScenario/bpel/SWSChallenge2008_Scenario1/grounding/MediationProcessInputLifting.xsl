...
xmlns="http://process.MediationProcessInput.owl#"
...
xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:template match="//po:Pip3A4PurchaseOrderRequest">
		...
		<rdf:RDF
			...
			xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#"
			xmlns:owl="http://www.w3.org/2002/07/owl#"
		  xml:base="http://process.MediationProcessInput.owl">
		  <owl:Ontology rdf:about="http://process.MediationProcessInput.owl">
